...
/**
 * Interface for classes capable of determining the data key for the {@link ExternalAPIReader}
 * based on the {@link ExternalCommand} received
 */
public interface ExternalDataKeyResolver<T extends SwarmStore> {

    /**
     * Resolve data key
     * @param command, e.g. <code>invoices.json?order_by=...</code>
     * @return e.g. <code>invoices</code>
     */
