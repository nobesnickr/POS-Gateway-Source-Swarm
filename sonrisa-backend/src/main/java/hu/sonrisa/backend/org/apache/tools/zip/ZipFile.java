...
public class ZipFile {
    ...
    public InputStream getInputStream(ZipEntry ze)
        ...
        switch (ze.getMethod()) {
            ...
            default:
                throw new ZipException(BackendExceptionConstants.BEND_00029
                                       + ze.getMethod());
        }
    }
    ...
    private Map populateFromCentralDirectory()
        ...
        if (sig != cfhSig && startsWithLocalFileHeader()) {
            throw new IOException(BackendExceptionConstants.BEND_00030);
        }
        while (sig == cfhSig) {
    ...
    private void positionAtCentralDirectory()
        ...
        if (!found) {
            throw new ZipException(BackendExceptionConstants.BEND_00031);
        }
    ...
    private void resolveLocalFileHeaderData(Map entriesWithoutUTF8Flag)
        ...
        while (e.hasMoreElements()) {
            ...
            while (lenToSkip > 0) {
                ...
                if (skipped <= 0) {
                    throw new RuntimeException(BackendExceptionConstants.BEND_00033);
                }
                lenToSkip -= skipped;
            }            
    ...
    protected String getString(byte[] bytes) throws ZipException {
        try {
            ...
            throw new ZipException(BackendExceptionConstants.BEND_00032 + ex.getMessage());
        }
    }
