...
public class ExtraFieldUtils {
    ...
    public static void register(Class c) {
        try {
            ...
            throw new RuntimeException(c + BackendExceptionConstants.BEND_00022);
        } catch (InstantiationException ie) {
            throw new RuntimeException(c + BackendExceptionConstants.BEND_00023);
        } catch (IllegalAccessException ie) {
            throw new RuntimeException(c + BackendExceptionConstants.BEND_00024);
        }
    }
        ...
        while (start <= data.length - WORD) {
            ...
            if (start + WORD + length > data.length) {
                ...
                case UnparseableExtraField.THROW_KEY:
                    throw new ZipException(BackendExceptionConstants.BEND_00025 + start
                                           + BackendExceptionConstants.BEND_00040
                                           + length + " > " + (data.length - start - WORD));
                ...
                case UnparseableExtraField.SKIP_KEY:
                    ...
                    break LOOP;
                default:
                    throw new ZipException(BackendExceptionConstants.BEND_00026
