 ...
 */
package com.sonrisa.swarm.shopify.job;
 ...
 *
 */
public class ShopifyExtractorLauncher extends ExtractorLauncher {

    /** External extractor to launch.  */
    @Autowired
    @Qualifier("ShopifyExtractor")
    ...
    protected SwarmStore createAccount(final StoreEntity store) {
        ShopifyAccount account = new ShopifyAccount(store, aesUtility);
        return account;                
    }
