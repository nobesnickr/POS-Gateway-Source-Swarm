...
/**
 * Class converting {@link StoreEntity} to {@link SwarmStore}
 */
@Service("lsProStoreFactory")
public class LsProStoreFactory implements SwarmStoreFactory<LsProAccount> {
     ...
     */
    @Override
    public LsProAccount getAccount(StoreEntity store) {
        return new LsProAccount(store, aesUtility);
    }
